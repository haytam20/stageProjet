    ...
    <div className="container mx-auto px-4 py-8 bg-gray-900"> 
      {selectedProduct ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 bg-gray-900">
            {filteredProducts.map((product, index) => (
              <div
                key={index}
                className="w-72 bg-teal-300 hover:bg-teal-200 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl cursor-pointer"
