        ...
        <div className="flex-1 flex flex-col justify-center items-center md:items-start p-8 md:p-12">
          <div>
            <h2 className="text-3xl font-semibold text-gray-800 md:text-4xl">
              Orlifix <span className="text-teal-300 ">vous accueille</span>
            </h2>
            ...
            <div className="flex justify-center md:justify-start mt-6">
              <Link
                className="px-4 py-3 bg-teal-300 text-slate-50 text-xs font-semibold rounded hover:bg-gray-800"
                to="/register"
              >
                Get Started
              </Link>
              {/* <Link className="mx-4 px-4 py-3 bg-teal-300 text-slate-50 text-xs font-semibold rounded hover:bg-gray-800" to="/products" > Les Produits </Link> */}
            </div>
          </div>
        </div>
