...
const ProductForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white border border-gray-200 shadow-lg rounded-md px-8 pt-6 pb-8">
      ...
      <button
        type="submit"
        className="w-full bg-teal-300 hover:bg-teal-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
      >
        Add Product
      </button>
    </form>
