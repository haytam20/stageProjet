    ...
    <form ref={form} onSubmit={sendEmail} className="flex flex-col items-center">
      <div className="py-4">
        <h1 className="text-gray-700 poppins text-3xl">
          Contact <span className="text-teal-300 font-semibold select-none">Us</span>
        </h1>
        <div className="bg-teal-300 flex items-center justify-center w-16 h-1 mt-2 rounded-full"></div>
      </div>
      <div className="p-6 flex flex-col justify-center w-full lg:w-2/4 mx-auto">
        ...
        <button type="submit" className="bg-teal-300 hover:bg-teal-400 text-white font-semibold py-2 px-4 rounded-lg w-36 mt-6">
          Submit
        </button>
      </div>
    </form>
