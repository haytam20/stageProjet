                ...
                <div className="flex flex-wrap -mx-3 items-center">
                    ...
                    <div className="w-full sm:w-1/2 md:w-2/4 px-3 text-left">
                        <div className="p-5 xl:px-8 md:py-5">
                            ...
                            <h5 className="text-2xl text-white  mb-2 text-transform: uppercase "></h5>
                            <p className="text-sm text-white">
                            Welcome, {userName}! Ready to explore? Feel free to search for products using "Search for product" button.
                              </p>
                        </div>
                    </div>
